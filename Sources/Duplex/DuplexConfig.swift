...
enum DuplexConfig {
    /// Where "Buy for $9" sends people: the live Dodo Payments checkout for
    /// the Duplex license product.
    static let checkoutURL = URL(string: "https://checkout.dodopayments.com/buy/pdt_0NoINwY9AdV4LZ5RIX0dH?quantity=1")!
